...
<template>
  <div id="DemoA6_2VFor">
    <fieldset>
      <legend align="left">DemoA6_2 v-for advance</legend>
    ...
    <fieldset>
      <legend align="left">DemoA6_3 use object inside v-for</legend>
    ...
    <fieldset>
      <legend align="left">DemoA6_4 about sort and filter of v-for</legend>
    ...
    <fieldset>
      <legend align="left">DemoA6_5 custom component &#60;DemoA6_3VForTodo&#62;</legend>
      ...
      <ul>
        <DemoA6_3VForTodo v-for="(todo, index) in todos" :key="todo.id" :title="todo.title" v-bind:titleId="todo.id" @remove="todos.splice(index, 1)"></DemoA6_3VForTodo>
      </ul>
    </fieldset>
