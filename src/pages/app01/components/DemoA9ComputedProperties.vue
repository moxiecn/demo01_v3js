...
-->
<template>
  <div id="DemoA9ComputedProperties">
    <fieldset>
      <legend align="left">DemoA9-1: a simple demo about computed properties</legend>
