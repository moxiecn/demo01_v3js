...
<template>
  <div id="DemoD1Comp">
    <fieldset>
      ...
      <fieldset>
        <legend align="left">DemoD1-1: Passing Data to Child Components with Props</legend>
        <span>
      ...
      <fieldset>
        ...
        <span>
          <div>
            ...
            <DemoD1CompSub2 v-for="(t,index) in titles" :key="index" v-bind:title="t.title" v-bind:index1="t.index" :titleFontSize="t.fsize" v-on:eventEnlarge="doEnlarge1" @eventReduce="doReduce1" />
          </div>
        </span>
        <br />
        <fieldset>
          <legend align="left">DemoD1-2_1: advanced usage of $emit()</legend>
          <span>
            <div>
              child components by v-for({{titleFontSize}}):
              <DemoD1CompSub2_1 v-for="(t,index) in titles" :key="index" v-bind:title="t.title" v-bind:index1="t.index" :titleFontSize="t.fsize" v-on:eventEnlarge="doEnlarge1" @eventReduce="doReduce1" />
            </div>
          </span>
          <br />
        </fieldset>
      ...
      <fieldset>
        ...
        <br />
        <fieldset>
          <legend align="left">DemoD1-31 advanced: modify attribute name</legend>
          <span>
        ...
        <fieldset>
          <legend align="left">DemoD1-32 advanced: multiple v-model binding on one component</legend>
          <span>
            <DemoD1CompSub32 v-model:vserach5="searchText5" v-model:vserach6="searchText6" sn="56" />
          </span>
        </fieldset>
        <fieldset>
          <legend align="left">DemoD1-33 advanced: v-model custom modifiers</legend>
          <span>
      ...
      <fieldset>
        ...
        <span align="left">
          ...
          <ul>
            <li>component name must be followed W3C rules, all lowercase and contains hyphen symbol if has multiple words.</li>
            ...
            <li>"import" and "export" is recommended to build the compoments system. Each component should be placed in "components" directory to facilitate the management of components.</li>
          </ul>
          <br />about props:
          <ul>
            <li>
              The definitions of "props" can be ['field1','field2'], this is simplest style, can also contain the defintions of type,validation. for more,
              <a href="https://vue3js.cn/docs/zh/guide/component-props.html#prop-类型">for more, refer to here</a>
            </li>
            <li>props can be passed a static or dynamic value, a string, a number, a boolean, a array, any entire object or a part of that object.</li>
            <li>All props is on-way binding beween parent component and child one, and can only pass data from parent to child, otherwise it can't.</li>
            <li>props are verfied before a component instance is created. so the properties of the instance( such as data,compouted,etc) are not available in the "default" or "validator" functions.</li>
          </ul>
          <fieldset>
            <legend align="left">a demo about props</legend>
            <DemoD1CompSub6 init-value="initValue" propD="105" />
            <br />
          </fieldset>
        </span>
        <br />
      ...
      <fieldset>
        ...
        <span align="left">
          ...
          <br />
          <a href="https://vue3js.cn/docs/zh/guide/component-attrs.html#禁用-attribute-继承">disabling attributes inheritance</a>
          <br />
          <a href="https://vue3js.cn/docs/zh/guide/component-attrs.html#多个根节点上的-attribute-继承">attributes inheritance on multiple root nodes</a>
        </span>
        <br />
      </fieldset>
    </fieldset>
...
import DemoD1CompSub2_1 from "./DemoD1CompSub2_1";
...
export default {
  ...
  components: {
    ...
    DemoD1CompSub2_1: DemoD1CompSub2_1,
  ...
  methods: {
    ...
    submitChange: function () {
      alert("submitChange is not defined.");
    },
  },
  computed: {
    currentTabComponent() {
