<!--declares a demo component, No. is DemoD2
  this demo is about custom event of component, $emit(), this is a simplest demo. 
-->
<template>
  <div id="DemoD1CompSub2">
    <span>
...
export default {
  ...
  emits: ["eventEnlarge", "eventRecude"],
  methods: {
