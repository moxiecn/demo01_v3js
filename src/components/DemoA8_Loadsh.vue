...
-->
<template>
  <div id="DemoA8_Loadsh">
    <fieldset>
      <legend align="left">DemoA8 debounce base on LOADSH</legend>
...
export default {
  ...
  methods: {
    myDoit: function(){               //working function actually executed on my custom.
      alert('this my normal function myDoit. 2000ms have passed');
    },
    myDoitLoadsh: function(){         //working function actually executed base on loadsh.
      alert('this my loadsh debounce function myDoitLoadsh.  2000ms have passed');
    },
    myDebounce: function(){           //bind to <button> tag, call dbf01 variable of this component by built in created hook funcion.
      this.dbf01();
    },
    _myDebounce: function(){          //bind to <button> tag, 
      this.dbf02();
    },
  },
};
